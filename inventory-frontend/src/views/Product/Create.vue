                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <vee-form :validation-schema="schema" enctype="multipart/form-data" @submit="StoreProduct">
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="name">Category Name</label>
                                        <vee-field as="select" v-model="formData.category_id" name="category_id" class="form-control mb-3"
                                            id="category_id">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <vee-field as="select" v-model="formData.brand_id" name="brand_id" class="form-control mb-3"
                                            id="brand_id">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <vee-field as="select" v-model="formData.supplier_id" name="supplier_id" class="form-control mb-3"
                                            id="supplier_id">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <vee-field type="text" v-model="formData.code" name="code" class="form-control mb-3"
                                            id="code" placeholder="Enter product code" />
                                        <ErrorMessage name="code" />
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="name">Original Price</label>
                                        <vee-field type="number" v-model="formData.original_price" name="original_price" class="form-control mb-3"
                                            id="original_price" placeholder="Enter Original Price" />
                                        <ErrorMessage name="original_price" />
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="name">Sell Price</label>
                                        <vee-field type="number" v-model="formData.sell_price" name="sell_price" class="form-control mb-3"
                                            id="sell_price" placeholder="Enter Sell Price" />
                                        <ErrorMessage name="sell_price" />
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="name">Stock</label>
                                        <vee-field type="number" v-model="formData.stock" name="stock" class="form-control mb-3"
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea v-model="formData.description" name="description" rows="5" class="form-control mb-3"
