...
const onFileChange = (e) => {
    expenseStore.editForm.file = e.target.files[0];
};
const UpdateExpense = () => {
    expenseStore.updateExpense(expenseStore.editForm,route.params.id);
};
//hooks and computed
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <vee-form :validation-schema="schema" enctype="multipart/form-data" @submit="UpdateExpense">
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="name">Expense Category</label>
                                        <vee-field as="select" v-model="expenseStore.editForm.expense_category_id" name="expense_category_id" class="form-control mb-3"
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <vee-field as="select" v-model="expenseStore.editForm.staff_id" name="staff_id" class="form-control mb-3"
                                            id="staff_id">
                                            <option value="">Select a Staff</option>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <vee-field type="text" v-model="expenseStore.editForm.amount" name="amount" class="form-control mb-3"
                                            id="amount" placeholder="Enter expense amount" />
                                        <ErrorMessage name="amount" />
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for="name">Note</label>
                                        <textarea v-model="expenseStore.editForm.note" name="note" class="form-control mb-3"
