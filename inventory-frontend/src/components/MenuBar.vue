                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-pages">
                                        ...
                                        <a href="apps-kanban-board.html" class="dropdown-item"
                                            data-key="t-kanban">Kanban Board</a>
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="topnav-auth">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="topnav-auth-basic">
                                                        ...
                                                        <a href="auth-emailverification-basic.html"
                                                            class="dropdown-item" data-key="t-email-verification">Email
                                                            Verification</a>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="topnav-auth-cover">
                                                        ...
                                                        <a href="auth-resetpassword-cover.html" class="dropdown-item"
                                                            data-key="t-reset-password">Reset Password</a>
                                                        <a href="auth-emailverification-cover.html"
                                                            class="dropdown-item" data-key="t-email-verification">Email
                                                            Verification</a>
